...
<span
	class="mono border-paper-edge inline-flex items-center rounded-full border {badge.toneClass}"
	style="padding: 2px 8px; font-size: 10.5px; letter-spacing: 0.02em; gap: 5px"
>
	{#if running}
