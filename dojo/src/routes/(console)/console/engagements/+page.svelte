				...
				{#each data.engagements as eng, i (eng.id)}
					...
					>
						...
						<div class="flex items-center gap-2">
							<a
								...
								style="padding: 5px 10px; background: transparent">Audit</a
							>
							<button
								type="button"
					...
					{#if bindingId === eng.id}
						<div
							...
							style="grid-template-columns: 1.2fr 1.2fr auto auto; padding: 12px 18px"
						>
							<label class="flex flex-col gap-1">
							...
							<button
								...
								style="padding: 8px 6px; cursor: pointer; background: transparent; border: none"
								>Cancel</button
							>
						</div>
					{/if}
