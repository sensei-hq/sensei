...
import { toKitRuns, toKitGates, toKitDecisions, toKitChatThread } from '$lib/dojo2-relay-map';
...
// to the kit shape by the pure dojo2-relay-map / dojo2-chrome mappers. The
