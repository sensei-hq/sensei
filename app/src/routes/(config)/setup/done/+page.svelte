    ...
    const stats = [
        {
            kanji: "観",
            label: "Observing",
            sub: "sessions tracked in real time",
        },
        {
            kanji: "師",
            label: "Teaching",
            sub: "after ~3 sessions per project",
        },
...
<div class="max-w-[720px]">
    ...
    <p
        class="text-base text-surface-z7 leading-loose max-w-[560px] m-0 mb-11"
    >
    ...
    >
        {#each stats as s}
            <div>
                ...
                <div class="display text-xl">{s.label}</div>
