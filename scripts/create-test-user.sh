...
#
# Users created:
#   jerry@example-corp.com  → jerry-thomas  (example-corp, owner, is_platform account)
...
ACCOUNT_SENECAGLOBAL=$(account_id "example-corp")
...
TEAM_PLATFORM_OPS=$(team_id "example-corp" "platform-ops")
...
echo "→ jerry@example-corp.com (jerry-thomas, example-corp owner + platform admin)"
UID_JERRY=$(create_or_fetch_user "jerry@example-corp.com" "Jerry Thomas")
...
echo ""
echo "  jerry@example-corp.com  / $PASSWORD  → /jerry-thomas  (platform + team access)"
