---
name: "OPSX: Reverse Engineer"
description: "Enterprise reverse engineering workflow with governance, NFR coverage, capability proposals/specs, structured backlog aggregation, multi-stack/monorepo auto-detection, version compliance enforcement, feature-driven mode entry, unclaimed file utility detection, inline DB schema analysis, and unified code quality tracking (including OWASP 2021 security checks)."
category: Workflow
tags: [reverse-engineer, product, feature, audit, specs, governance, compliance, nfr, code-quality, stack-adapter, owasp, monorepo, utilities, schema, orm]
---
