...
[[pipeline/insight-copy]] — embedded gemma4 first, static template as
...
fact-set and passes it to `generate_insight_copy(kind, facts)` (see
[[pipeline/insight-copy]]). Facts must be small (< 200 tokens) and
