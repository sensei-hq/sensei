...
window.SENSEI_SETUP = {
  ...
  inference: {
    ...
    providers: [
      ...
      { id: "embedded-ollama", name: "Embedded Ollama", kanji: "内",
        kind: "local",  envVar: null,
        detected: true,  configured: true,
        note: "bundled with sensei · runs in-process · nothing to install",
        models: [
          { id: "emb-qwen-7b",        name: "Qwen2.5 7B",        role: "inference",
            sizeGB: 4.7, pulled: true,  recommended: true,
            note: "bundled default · general reasoning & chat" },
          { id: "emb-nomic-embed",    name: "Nomic Embed v1.5",  role: "embedding",
            sizeGB: 0.3, pulled: true,  recommended: true,
            note: "bundled · indexes sessions & memories" },
          { id: "emb-deepseek-r1-8b", name: "DeepSeek-R1 8B",    role: "consolidation",
            sizeGB: 4.9, pulled: false, recommended: true,
            note: "fast reasoning · memory consolidation" },
          { id: "emb-qwen2-vl-7b",    name: "Qwen2-VL 7B",       role: "image",
            sizeGB: 6.1, pulled: false, recommended: false,
            note: "vision · reads screenshots & diagrams" }
        ]},
