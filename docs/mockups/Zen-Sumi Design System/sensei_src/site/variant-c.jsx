...
//
// Color model: static ramp colors use utility classes (text-accent,
// text-ink-soft, bg-paper-soft, border-t, …). Gradients, data-driven
// tone colors (var(--${tone})), and the dark inverted sections stay
// inline — they're computed, not ramp tokens. tone values map to the
// semantic names: accent / success / warning.

const { useState: cS, useEffect: cE } = React;

function VariantC() {
  return (
    <div className="sensei variant-c bg-paper text-ink" style={{
      minHeight: '100%'
    }}>
      <NavC/>
      <HeroC/>
    ...
    <section style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto',
        ...
        <div style={{ position: 'relative' }}>
          <div className="bg-paper-soft border text-ink-soft" style={{
          ...
          <p className="text-ink-soft" style={{ fontSize: 18,
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'center',
            ...
            <a href="#how" className="bg-paper text-ink" style={{
              display: 'inline-flex', alignItems: 'center', gap: 8,
              padding: '14px 22px',
          ...
          <div className="text-ink-mute" style={{ display: 'flex', gap: 18,
...
function DownloadCTAC({ size = "lg" }) {
  ...
  return (
    <a href={`#download-${os.toLowerCase()}`} className="text-paper"
       style={{
...
function LogoStripC() {
  ...
  return (
    <section className="border-t border-b bg-paper-soft" style={{
                       padding: '28px 48px' }}>
      <div className="text-ink-mute" style={{ maxWidth: 1280, margin: '0 auto',
                     display: 'flex',
                     alignItems: 'center',
                     justifyContent: 'space-between',
                     fontSize: 11,
        ...
        <div className="text-ink-soft" style={{ display: 'flex', gap: 36,
    ...
    <section style={{ padding: '120px 48px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 80 }}>
          <div className="text-accent" style={{ fontSize: 11,
...
function HowItWorksC() {
  ...
  return (
    <section id="how" className="border-t border-b" style={{
      padding: '120px 48px',
...
function PhilosophyC() {
  return (
    <section id="philosophy" className="text-paper" style={{
      padding: '160px 48px',
      ...
      <div style={{ maxWidth: 820, margin: '0 auto',
        ...
        <h2 className="display text-paper" style={{ fontSize: 52, fontWeight: 300,
        ...
        <div style={{ display: 'grid',
          ...
          {[
            ...
            <div key={i} className="bg-paper-soft border" style={{
              ...
              <span className="kanji text-ink-soft" style={{ fontSize: 28 }}>{it.k}</span>
              <div className="display" style={{ fontSize: 18,
                             marginTop: 14, marginBottom: 10,
                             letterSpacing: '-0.01em' }}>{it.title}</div>
              <div className="text-ink-soft" style={{ fontSize: 13.5,
...
function PricingC() {
  return (
    <section className="border-t border-b" style={{
      padding: '120px 48px',
  ...
  return (
    <section id="faq" style={{ padding: '120px 48px' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <div>
          {qs.map((it, i) => (
            <details key={i} className="bg-paper-soft border" style={{
              borderRadius: 10,
              marginBottom: 12,
              padding: '20px 24px'
            }}>
...
function SupportC() {
  return (
    <section className="border-t" style={{
      padding: '100px 48px',
      background: `linear-gradient(180deg, var(--paper) 0%, var(--paper-soft) 100%)`,
      textAlign: 'center'
    }}>
      <div className="bg-paper border" style={{ maxWidth: 720, margin: '0 auto',
                     padding: '48px 32px',
                     borderRadius: 16,
                     boxShadow: '0 20px 50px -20px rgba(20,18,14,0.15)' }}>
        <span className="kanji text-accent" style={{ fontSize: 48 }}>志</span>
        ...
        <a href="#sponsor" className="text-paper" style={{
          display: 'inline-flex', alignItems: 'center', gap: 10,
          padding: '14px 28px',
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto',
        ...
        <div style={{ maxWidth: 320 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10,
            ...
            <span className="kanji text-accent" style={{ fontSize: 22,
                           letterSpacing: '-0.04em' }}>先生</span>
            <span className="display text-paper" style={{ fontSize: 18 }}>Sensei</span>
          </div>
...
function FooterColC({ title, links }) {
  return (
    <div>
      <div className="text-accent" style={{ fontSize: 9.5,
                     letterSpacing: '0.22em',
                     textTransform: 'uppercase',
