...
// but turned up. Bigger display type, larger imagery, more accent where
// it earns its place, more rhythm between sections (paper / paper-soft
// alternation, taller blocks). Still feels like the app, but louder.
//
// Color/surface/border come from utility classes (bg-paper-soft,
// text-ink-mute, border-t, …). Only layout/size and dynamic styles
// stay inline. Ink ramp: default → soft → mute → faint.

const { useState: bS, useEffect: bE } = React;

function VariantB() {
  return (
    <div className="sensei variant-b bg-paper text-ink" style={{
      minHeight: '100%'
    }}>
      <NavB/>
      <HeroB/>
  ...
  return (
    <nav className="border-b" style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
        <span className="kanji text-accent" style={{ fontSize: 24,
                       letterSpacing: '-0.04em' }}>先生</span>
        <span className="display text-ink" style={{ fontSize: 19,
...
function HeroB() {
  return (
    <section style={{ padding: '72px 56px 40px',
      ...
      <div className="kanji text-accent-soft"
      ...
      <div style={{ position: 'relative' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 14,
                       marginBottom: 24 }}>
          <span className="ink-dot" style={{ width: 8, height: 8 }}/>
        ...
        <h1 className="display" style={{
          fontSize: 84, fontWeight: 300, lineHeight: 1.02,
          letterSpacing: '-0.03em',
          margin: 0, maxWidth: 920
        }}>
          A quiet companion<br/>
          for AI-assisted <em className="text-accent"
                          style={{ fontStyle: 'normal' }}>work</em>.
        </h1>
        <p className="text-ink-soft" style={{ fontSize: 19,
        ...
        <div style={{ display: 'flex', gap: 18, alignItems: 'center',
          ...
          <a href="#how" className="text-ink-soft" style={{ fontSize: 14 }}>
            See how it works ↓
          </a>
        </div>
        <div className="text-ink-mute" style={{ fontSize: 11.5,
                       marginTop: 16,
...
function DownloadCTAB({ size = "lg" }) {
  ...
  return (
    <a href={`#download-${os.toLowerCase()}`} className="bg-ink"
      ...
      <span className="kanji text-accent" style={{ fontSize: fs + 4 }}>下</span>
      Download for {os}
    </a>
  );
}
...
function StatsB() {
  return (
    <section className="border-t border-b bg-paper-soft"
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto',
        ...
        {[
          ...
          <div key={i} style={{ textAlign: 'center' }}>
            <div className="display text-ink" style={{ fontSize: 30,
                           fontWeight: 400 }}>
              {s.v}
            </div>
    ...
    <section style={{ padding: '120px 56px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto',
        ...
        <div>
          ...
          <h2 className="display" style={{ fontSize: 44, fontWeight: 300,
        ...
        <div className="text-ink-soft" style={{ fontSize: 18, lineHeight: 1.65,
...
function HowItWorksB() {
  ...
  return (
    <section id="how" className="border-t border-b bg-paper-soft" style={{
      padding: '120px 56px'
    }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="text-ink-mute" style={{ fontSize: 11,
        ...
        <h2 className="display" style={{ fontSize: 56, fontWeight: 300,
                       margin: '0 0 72px', letterSpacing: '-0.025em',
                       lineHeight: 1.05 }}>
          <span className="text-accent">観 · 察 · 覚</span><br/>
          Watch, notice, adopt.
        </h2>
        <div style={{ display: 'grid',
                       ...
                       gap: 64 }}>
          {steps.map((s, i) => (
            <div key={i} className="bg-paper border" style={{
              padding: '32px 28px',
              borderRadius: 12,
              position: 'relative'
            }}>
              <div className="kanji text-accent" style={{ fontSize: 48,
                             lineHeight: 1,
                             marginBottom: 18 }}>{s.kanji}</div>
              <div className="text-ink-mute" style={{ fontSize: 10.5,
                             letterSpacing: '0.22em',
                             textTransform: 'uppercase',
                             marginBottom: 10 }}>{s.phase}</div>
              <h3 className="display" style={{ fontSize: 22,
                             fontWeight: 400,
                             margin: '0 0 16px',
                             letterSpacing: '-0.01em' }}>{s.title}</h3>
              <div className="text-ink-soft" style={{ fontSize: 14,
                             lineHeight: 1.65, marginBottom: 20 }}>
                {s.text}
              </div>
              <div className="text-ink-mute border-t" style={{ fontSize: 11.5,
                             fontStyle: 'italic',
                             paddingTop: 14 }}>
                {s.sub}
              </div>
...
function GalleryB() {
  ...
  return (
    <section id="gallery" style={{ padding: '120px 56px 60px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="text-ink-mute" style={{ fontSize: 11,
                       letterSpacing: '0.22em',
                       textTransform: 'uppercase', marginBottom: 16 }}>
        ...
        <p className="text-ink-soft" style={{ fontSize: 17,
...
function PhilosophyB() {
  return (
    <section id="philosophy" className="border-t border-b bg-paper-soft" style={{
      padding: '160px 56px',
      position: 'relative',
      overflow: 'hidden'
    }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto',
        ...
        <p className="text-ink-soft" style={{ fontSize: 15,
...
function PrivacyB() {
  return (
    <section id="privacy" className="bg-paper" style={{
      padding: '120px 56px'
    }}>
      <div style={{ maxWidth: 1200, margin: '0 auto',
                     display: 'grid',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          {[
            ...
            <div key={i} style={{ display: 'grid',
                       gridTemplateColumns: 'auto 1fr', gap: 22,
                       paddingBottom: 32,
                       borderBottom: i < 2 ? 'var(--hairline)' : 'none' }}>
              <span className="kanji text-ink-soft" style={{ fontSize: 32 }}>{it.k}</span>
              <div>
                <div className="display" style={{ fontSize: 20,
                               marginBottom: 10,
                               letterSpacing: '-0.01em' }}>{it.title}</div>
                <div className="text-ink-soft" style={{ fontSize: 15,
...
function PricingB() {
  return (
    <section className="border-t border-b bg-paper-soft" style={{
                       padding: '120px 56px',
                       textAlign: 'center' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div className="text-ink-mute" style={{ fontSize: 11,
...
function FaqB() {
  ...
  return (
    <section id="faq" style={{ padding: '120px 56px' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <h2 className="display" style={{ fontSize: 44, fontWeight: 300,
                       margin: '0 0 56px', letterSpacing: '-0.025em',
                       lineHeight: 1.1 }}>
          Common questions,<br/>
          plain answers.
        </h2>
...
function SupportB() {
  return (
    <section className="border-t bg-paper-soft" style={{
      padding: '100px 56px',
      textAlign: 'center'
    }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <h2 className="display" style={{ fontSize: 32, fontWeight: 300,
        ...
        <a href="#sponsor" className="bg-accent" style={{
...
function FooterB() {
  return (
    <footer className="border-t text-ink-mute" style={{
      padding: '56px 56px',
      fontSize: 12
    }}>
      <div style={{ maxWidth: 1200, margin: '0 auto',
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10,
                         marginBottom: 12 }}>
            <span className="kanji text-accent" style={{ fontSize: 18,
                           letterSpacing: '-0.04em' }}>先生</span>
            <span className="display text-ink-soft" style={{ fontSize: 16 }}>Sensei</span>
          </div>
          <div className="text-ink-mute" style={{ fontSize: 11,
          ...
          <div className="mono text-ink-faint" style={{ fontSize: 10,
                         marginTop: 14 }}>
            v0.4.2
          </div>
        </div>
...
function FooterCol({ title, links }) {
  return (
    <div>
      <div className="text-ink-faint" style={{ fontSize: 9.5,
                     letterSpacing: '0.22em',
                     textTransform: 'uppercase',
                     marginBottom: 12 }}>{title}</div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {links.map((l, i) => (
          <a key={i} href={`#${l.toLowerCase()}`} className="text-ink-soft"
             style={{ fontSize: 12 }}>{l}</a>
        ))}
      </div>
    </div>
  );
