  ...
  return (
    <div className="sensei" data-screen-label="Observatory · Traceability"
      ...
      <div style={{ padding: '22px 36px 18px', borderBottom: 'var(--hairline)',
        ...
        <div className="kanji" style={{ fontSize: 42, color: 'var(--accent)', lineHeight: 1 }}>巻</div>
            ...
            <button key={p.id}
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 6 }}>
                ...
                <span className="mono" style={{ fontSize: 11.5,
                              color: on ? 'var(--ink)' : 'var(--ink-soft)' }}>{p.name}</span>
                <span style={{ flex: 1 }}/>
                <span className="mono" style={{ fontSize: 11,
                              color: p.healthPct >= 0.9 ? 'var(--success)' :
                                     p.healthPct >= 0.8 ? 'var(--ink-soft)' : 'var(--warning)' }}>
      ...
      <div style={{ display: 'flex', gap: 22, padding: '16px 0',
        ...
        {(drifted + broken) > 0 && (
          <button style={{ padding: '8px 16px', fontSize: 12,
            ...
            <span className="kanji" style={{ fontSize: 12, color: 'var(--accent)' }}>直</span>
  ...
  return (
    <article style={{ background: 'var(--paper-soft)', border: 'var(--hairline)',
      ...
      <div className="mono" style={{ fontSize: 11, color: 'var(--ink-mute)', marginTop: 6 }}>
        ...
        <span style={{ color: 'var(--ink-faint)' }}>  ·  {r.target.path}</span>
      </div>
      ...
      {r.status !== "current" && (
        <div style={{ marginTop: 10, padding: '10px 12px',
                       ...
                       border: 'var(--hairline)' }}>
          <div style={{ fontSize: 10, letterSpacing: '0.14em', color: 'var(--ink-faint)',
                         textTransform: 'uppercase', marginBottom: 6 }}>signature delta</div>
          <div className="mono" style={{ fontSize: 11, color: 'var(--ink-soft)',
                                          lineHeight: 1.55 }}>
            <div style={{ color: 'var(--ink-mute)' }}>doc says:  {r.expected}</div>
