...
const VERDICT_META = {
  ...
  neutral:  { glyph: "並", color: "var(--ink-mute)", label: "no measurable effect" },
  ...
  return (
    <div className="sensei" data-screen-label="Observatory · Change impact"
      ...
      <div style={{ padding: '22px 36px 18px', borderBottom: 'var(--hairline)',
        ...
        <div className="kanji" style={{ fontSize: 42, color: 'var(--accent)', lineHeight: 1 }}>果</div>
    ...
    <div style={{ maxWidth: 800 }}>
      ...
      <div style={{ background: 'var(--paper-soft)', border: 'var(--hairline)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
          <span className="kanji" style={{ fontSize: 14, color: 'var(--accent)' }}>議</span>
        ...
        {r.moeReasoning.suggestedRevision && (
          <div style={{ marginTop: 14, padding: '10px 12px',
                         ...
                         border: 'var(--hairline)' }}>
            <div style={{ fontSize: 10, letterSpacing: '0.14em', color: 'var(--accent)',
...
function BeforeAfter({ label, before, after, delta, positive }) {
  return (
    <div style={{ background: 'var(--paper-soft)', padding: '14px 16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
        ...
        {after && <span style={{ fontSize: 11, color: 'var(--ink-faint)' }}>→</span>}
        {after && (
  ...
  return (
    <div className="sensei" data-screen-label="Observatory · Negative impact alert"
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '32px 60px 40px',
        ...
        <p style={{ fontSize: 14, color: 'var(--ink-soft)', lineHeight: 1.65, margin: '0 0 28px' }}>
          {r.moeReasoning.headline}
        </p>
            ...
            {r.moeReasoning.models.map((m, i) => {
              ...
              return (
                <div key={i} style={{ display: 'grid',
                  ...
                  <span style={{ fontSize: 11.5, color: 'var(--ink-soft)', lineHeight: 1.55 }}>
                    {m.note}
                  </span>
                </div>
              );
        ...
        {r.moeReasoning.suggestedRevision && (
          <div style={{ background: 'var(--paper)', border: '1px solid var(--accent)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <span className="kanji" style={{ fontSize: 14, color: 'var(--accent)' }}>改</span>
              <span style={{ fontSize: 10.5, letterSpacing: '0.14em', color: 'var(--accent)',
  ...
  return (
    <div style={{ background: 'var(--paper-soft)', border: 'var(--hairline)',
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
        <span className="display" style={{ fontSize: 28, fontWeight: 300, color: 'var(--ink-mute)',
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4,
                       fontSize: 12, color: bad ? 'var(--accent)' : 'var(--success)',
                       fontWeight: 500 }}>
