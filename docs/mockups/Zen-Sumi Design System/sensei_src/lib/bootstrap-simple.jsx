        ...
        <div style={{ maxWidth: 640, width: '100%' }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              <span className="kanji" style={{ fontSize: 20, color: 'var(--accent)' }}>支</span>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-mute)', lineHeight: 1.65, margin: 0,
                         maxWidth: 540 }}>
              {state === "all-green"
                ? "Everything sensei needs is here. Opening the observatory."
              : state === "auto-fixing"
                ? <>Running <span className="mono" style={{ color: 'var(--ink-soft)' }}>{platform.bundleCmd.split(" ")[0]}</span> with the manifest from <span className="mono" style={{ color: 'var(--ink-soft)' }}>sensei-hq/homebrew-tap</span>. No input needed.</>
              : reasonCopy}
            </p>
          </div>
          ...
          <div style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 1.55 }}>
            ...
            {isFixing  && (
              <span>
                ...
                <span className="mono" style={{ marginLeft: 8, color: 'var(--ink-faint)', fontSize: 11 }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '14px 18px', borderBottom: 'var(--hairline)',
        ...
        <span className="kanji" style={{ fontSize: 16, color: 'var(--accent)' }}>手</span>
        <div style={{ flex: 1 }}>
      ...
      {scriptOpen && (
        <>
          ...
          <pre style={{
            ...
            color: 'var(--ink)', background: 'var(--paper-mute)',
