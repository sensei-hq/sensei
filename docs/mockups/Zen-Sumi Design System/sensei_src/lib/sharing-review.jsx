...
const CAT_META = {
  ...
  correction:   { glyph: "直", label: "Correction",    color: "var(--ink-soft)"},
  ftr:          { glyph: "果", label: "FTR signal",    color: "var(--success)"  },
  model:        { glyph: "型", label: "Model",         color: "var(--ink-soft)"},
  skill:        { glyph: "技", label: "Skill",         color: "var(--success)"  },
  tool:         { glyph: "具", label: "Tool",          color: "var(--ink-soft)"},
  ...
  return (
    <div className="sensei" data-screen-label="Observatory · Memories · Next share"
      ...
      <div style={{ padding: '22px 36px 18px', borderBottom: 'var(--hairline)',
        ...
        <div className="kanji" style={{ fontSize: 42, color: 'var(--accent)', lineHeight: 1 }}>共</div>
            ...
            return (
              <article key={ins.id}
                       style={{ display: 'grid',
                                 ...
                                 padding: '16px 18px',
                                 background: out ? 'transparent' : 'var(--paper-soft)',
