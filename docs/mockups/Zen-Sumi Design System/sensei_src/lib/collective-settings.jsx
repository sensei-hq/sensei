  ...
  return (
    <div className="sensei" data-screen-label="Observatory · Settings · Collective intelligence"
      ...
      <div style={{ padding: '22px 36px 18px', borderBottom: 'var(--hairline)',
        ...
        <div className="kanji" style={{ fontSize: 42, color: 'var(--accent)', lineHeight: 1 }}>群</div>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '32px 60px 48px',
        ...
        <Section title="Sharing mode"
          ...
          {mode !== "off" && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10,
              ...
              <span style={{ flex: 1 }}/>
              {mode === "review" && (
                <button style={{ fontSize: 11.5, color: 'var(--accent)',
            ...
            {cats.map(c => (
              <label key={c.id}
                ...
                <span className="kanji" style={{ fontSize: 16,
                              color: c.enabled ? 'var(--accent)' : 'var(--ink-faint)',
        ...
        <Section title="Lifetime contribution"
          ...
          <div style={{ fontSize: 12, color: 'var(--ink-soft)', lineHeight: 1.6,
            ...
            <span className="kanji" style={{ fontSize: 14, color: 'var(--success)' }}>礼</span>
            <span>
...
function PrivacyRow({ glyph, label, sub, danger }) {
  return (
    <button style={{ display: 'grid',
      ...
      <span className="kanji" style={{ fontSize: 18,
                    color: danger ? 'var(--accent)' : 'var(--ink-mute)' }}>{glyph}</span>
      <div>
        <div style={{ fontSize: 12.5, color: danger ? 'var(--accent)' : 'var(--ink)',
