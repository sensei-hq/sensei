      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '300px 1fr',
        ...
        <main style={{ overflow: 'auto', padding: '22px 40px 40px' }}>
          ...
          <div style={{ display: 'flex', gap: 4, marginBottom: 14 }}>
            {[
              { id: "all",     label: "all",      tone: "var(--ink-soft)" },
              ...
              return (
                <button key={f.id} onClick={() => setCallFilter(f.id)}
                  ...
                  <span className="mono" style={{ fontSize: 10,
                                color: on ? 'var(--paper)' : 'var(--ink-faint)', opacity: 0.9 }}>
                    {counts[f.id]}
                  </span>
                </button>
              );
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0,
                ...
                {filteredCalls.length === 0 && (
                  <div style={{ padding: '18px 12px', fontSize: 12, color: 'var(--ink-faint)',
                                 textAlign: 'center' }}>
                    No calls match.
                  </div>
                )}
...
function usageBadge(u) {
  ...
  return { label: u, color: "var(--ink-mute)", glyph: "·" };
}
