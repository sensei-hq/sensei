...
window.PROJECT_DATA = {
  ...
  projects: {
    "lumen-studio": {
      ...
      icon: { kind: "kanji", value: "工", bg: "var(--accent-soft)", fg: "var(--accent)" },
      stack: {
    ...
    "lumen-cloud": {
      ...
      icon: { kind: "kanji", value: "雲", bg: "var(--success-soft)", fg: "var(--success)" },
      stack: {
    ...
    "brand-kit": {
      ...
      icon: { kind: "kanji", value: "紋", bg: "var(--warning-soft)", fg: "var(--warning)" },
      stack: {
